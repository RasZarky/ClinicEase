...
import 'custom_font_text_buttons.dart';
          ...
          child: ListTile(
            ...
            subtitle: Column(
              children: [
                ...
                const SizedBox(height: 10,),
                Text('Author: Dr. ${widget.author}',style: GoogleFonts.alegreya(fontSize: 20,fontWeight: FontWeight.bold),),
                Padding(padding: const EdgeInsets.all(8),child: Text(widget.publishedAt.substring(0,widget.publishedAt.indexOf('.'))))
              ],
            ),
            //trailing: ,
