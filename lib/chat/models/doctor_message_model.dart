...
import 'package:myccaa/chat/models/user_model.dart';
...
final User user1=User(id:1,name:'Patient 1',imageUrl: 'assets/black.jpg');

final User user2=User(id:2,name:'Patient 2',imageUrl: 'assets/hulk.jpg');
final User user3=User(id:3,name:'Patient 3',imageUrl: 'assets/captain.jpg');
final User user4=User(id:4,name:'Patient 4',imageUrl: 'assets/ironman.jpg');
final User user5=User(id:5,name:'Patient 5',imageUrl: 'assets/thor.jpg');
