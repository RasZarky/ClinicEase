...
final User user1=User(id:1,name:'Doctor 1',imageUrl: 'assets/black.jpg');

final User user2=User(id:2,name:'Doctor 2',imageUrl: 'assets/hulk.jpg');
final User user3=User(id:3,name:'Doctor 3',imageUrl: 'assets/captain.jpg');
final User user4=User(id:4,name:'Doctor 4',imageUrl: 'assets/ironman.jpg');
final User user5=User(id:5,name:'Doctor 5',imageUrl: 'assets/thor.jpg');
