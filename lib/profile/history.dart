...
class History extends StatefulWidget {
  ...
  @override
  State<History> createState() => _HistoryState(Id: Id);
}

class _HistoryState extends State<History> {

  final String Id;
  _HistoryState({ required this.Id});
    ...
    return GestureDetector(
      onTap: (){
        Navigator.push(
          context,
          MaterialPageRoute(
              builder: (context) => HistoryDetails2(history: pending,)),
        );
      },
      child: Container(
  ...
  Widget build(BuildContext context) {
    ...
    Query dbRef1 = FirebaseDatabase.instance.ref().child('records').orderByChild('patient Id').equalTo(Id);
